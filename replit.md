...
- June 20, 2025. **COMPLETED FORM-TYPE-BASED DOCUMENT SPLITTING** - Successfully implemented intelligent form-type grouping instead of page-by-page splitting. System now processes ALL pages in documents (removed 10-page limit), groups consecutive pages by document type (e.g., Freight Forwarder Receipt Pages 10-38), and displays proper page ranges in results. Enhanced document type detection with 15+ trade finance form patterns including Letter of Credit, Commercial Invoice, Bill of Lading, Certificate of Origin, Packing List, Insurance Certificate, Inspection Certificate, Bill of Exchange, Freight Forwarder Receipt, Multimodal Transport Document, Bank Draft, Customs Declaration, Weight Certificate, Quality Certificate, Fumigation Certificate, and Health Certificate. Added delete functionality to Document History tab with confirmation dialog and backend API endpoints. System correctly identifies and groups documents by form type rather than splitting every individual page.
