  ...
  app.get('/api/form-detection/history', async (req, res) => {
    try {
      ...
      res.status(500).json({ error: 'Failed to load document history' });
          ...
          fullText: "Letter of Credit containing multiple trade finance documents",
        ...
        },
        {
          ...
          confidence: 88,
          extractedText: "Commercial Invoice document with line items and pricing",
          fullText: "Commercial Invoice with detailed transaction information",
        ...
        },
        {
          ...
          confidence: 89,
          extractedText: "Vessel certification document",
          fullText: "Vessel certification confirming seaworthiness and compliance",
          processedAt: new Date("2025-06-19"),
          docId: "vessel_006",
          detectedForms: []
        }
